...
function WishlistCard({imageUrl,Item,Cost,Category,onPress,wishlistState,setWishlist}) 
{
...
<View style={{position:"absolute",right:20,top:20}}>
    <TouchableWithoutFeedback onPress={()=>{
        ...
        >
            <View style={{width:50,height:50,alignItems:"center",flex:1}}>
            <MaterialCommunityIcons name="close" size={30} style={{color: 'grey'}}  />
            </View>
